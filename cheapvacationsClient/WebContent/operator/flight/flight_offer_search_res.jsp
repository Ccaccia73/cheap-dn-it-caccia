...
<body>
	...
	<div class="wrapper">
		...
		<hr />
		<br />
		<h3 style="">Manage Flight OFFERS</h3>
			...
			if(fol != null && fol.size() > 0){
				...
				DateUtility du = new DateUtility();
					...
					while(i.hasNext()){
						...
						out.println("<button name=\"fo_id\" type=\"submit\" value=\""+fo1.getId()+"\">Remove Offer</button>");
						out.println("<input type=\"hidden\" name=\"op\" value=\"4\"/>");
						out.println("</form>");
						out.println("<br /> <br />");
						out.println("<form action=\"/cheapvacationsClient/PackageServlet\" method=\"get\">");
						out.println("<button name=\"fo_id\" type=\"submit\" value=\""+fo1.getId()+"\">See Related Packages</button>");
