		...
		<blockquote>
			<% Iterator<Flight> i = fl.iterator();
				while(i.hasNext()){
					...
					out.print("<button name=\"fid\" type=\"submit\" value=\""+f1.getId()+"\">See related Packages</button>");
					out.print("<input type=\"hidden\" name=\"op\" value=\"7\"/>");
					out.print("<br /> <br /> </form>");					
					out.print("</div>");
					/*
				<form action="flight_feedbacks.jsp" method="get">
					<button name="feedbacks" type="submit" value="view">View
