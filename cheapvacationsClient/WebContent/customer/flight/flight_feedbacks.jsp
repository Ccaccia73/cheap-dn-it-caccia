...
<body>
	...
	<div class="wrapper">
		...
		<hr />
		<br />
		<h3 style="display: inline;">Flight Feedbacks</h3>
		...
		<div id="flight-details"
			style="float: left; margin-left: 30px; margin-right: 100px; border-left: dotted orange 1px; padding: 10px; padding-left: 30px;">
			<div id="flight-name"
				style="color: orange; font-weight: bold; margin-top: 20px;">Codice
				Volo #1</div>
			<div id="flight-details" style="float: left;">
				<p>
					<label>Airline: </label>
				</p>
				<p>
