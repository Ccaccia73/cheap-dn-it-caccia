		...
		<% 
			if(hol != null && hol.size() > 0){
				...
				DateUtility du = new DateUtility();
					...
					out.println("<div id=\"hotel-name\" style=\"clear: both; color: orange; font-weight: bold; border-top: dotted orange 1px; margin-top: 50px;\">Name: ");
					out.println(h1.getName());
					out.println("</div>");
					out.println("<div id=\"hotel-details\" style=\"float: left\">");
					out.println("<p>Address: "+h1.getAddress()+"</p>");
					out.println("<p>City: "+h1.getCity()+"</p>");
					out.println("</div>");
					...
					while(i.hasNext()){
						...
						out.println("<br />");
						out.println("<p>Operator: "+ho1.getReferenceHotelOperator().getUsername()+"</p>");
						out.println("<br />");
						...
						out.println("<button name=\"ho_id\" type=\"submit\" value=\""+ho1.getId()+"\">Add to Package</button>");
